...
public class    ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng ShopLilWind = new LatLng(10.790859, 106.682421);
        mMap.addMarker(new MarkerOptions().position(ShopLilWind).title("G3 Shop").snippet("391A Nam Kỳ Khởi Nghĩa").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(ShopLilWind).zoom(90).build();
